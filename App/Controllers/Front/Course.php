...
class Course extends Base
{
     ...
     */
     ...
     public function indexAction()
     {
         try {
             ...
             $maxPerPage = 10;
             $courses = CourseQuery::create()->orderByName('asc')->paginate($page, $maxPerPage);
             if ($page != $courses->getPage()){
                 throw new CustomException("Страница не найдена", 404);
             }

             $this->breadcrumbs->appendItem('Курсы', '/courses');
             ...
             View::renderTemplate('Front/courses.html', $this->data);
    ...
    public function singleAction()
    {
        ...
        try {
            ...
            $course = CourseQuery::create()->findOneByAltUrl(trim($altUrl));
            if (is_null($course)){
            ...
            $this->breadcrumbs->appendItem('Курсы', '/courses');
            $this->breadcrumbs->appendItem($course->getTitle(), '/courses/' . $course->getAltUrl());
            $this->breadcrumbs->setOnRightSide(false);
            ...
            View::renderTemplate('Front/course.html', $this->data);
