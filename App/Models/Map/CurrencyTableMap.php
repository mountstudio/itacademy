...
class CurrencyTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Models.Map.CurrencyTableMap';
     ...
     */
    const OM_CLASS = '\\Models\\Currency';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Models.Currency';
     ...
     */
    const COL_ISO_CODE = 'currency.iso_code';
    ...
    /**
     * the column name for the is_symbol_before field
     */
    const COL_IS_SYMBOL_BEFORE = 'currency.is_symbol_before';

    /**
     * the column name for the notes field
     */
    const COL_NOTES = 'currency.notes';

    /**
     * the column name for the sortable_rank field
     */
    const COL_SORTABLE_RANK = 'currency.sortable_rank';
     ...
     * rank column
     */
    const RANK_COL = "currency.sortable_rank";
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'ISOCode', 'Symbol', 'IsSymbolBefore', 'Notes', 'SortableRank', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'iSOCode', 'symbol', 'isSymbolBefore', 'notes', 'sortableRank', ),
        self::TYPE_COLNAME       => array(CurrencyTableMap::COL_ID, CurrencyTableMap::COL_NAME, CurrencyTableMap::COL_ISO_CODE, CurrencyTableMap::COL_SYMBOL, CurrencyTableMap::COL_IS_SYMBOL_BEFORE, CurrencyTableMap::COL_NOTES, CurrencyTableMap::COL_SORTABLE_RANK, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'iso_code', 'symbol', 'is_symbol_before', 'notes', 'sortable_rank', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'ISOCode' => 2, 'Symbol' => 3, 'IsSymbolBefore' => 4, 'Notes' => 5, 'SortableRank' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'iSOCode' => 2, 'symbol' => 3, 'isSymbolBefore' => 4, 'notes' => 5, 'sortableRank' => 6, ),
        self::TYPE_COLNAME       => array(CurrencyTableMap::COL_ID => 0, CurrencyTableMap::COL_NAME => 1, CurrencyTableMap::COL_ISO_CODE => 2, CurrencyTableMap::COL_SYMBOL => 3, CurrencyTableMap::COL_IS_SYMBOL_BEFORE => 4, CurrencyTableMap::COL_NOTES => 5, CurrencyTableMap::COL_SORTABLE_RANK => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'iso_code' => 2, 'symbol' => 3, 'is_symbol_before' => 4, 'notes' => 5, 'sortable_rank' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Models\\Currency');
        $this->setPackage('Models');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('name', 'Name', 'VARCHAR', true, 255, null);
        $this->addColumn('iso_code', 'ISOCode', 'VARCHAR', true, 255, null);
        $this->addColumn('symbol', 'Symbol', 'VARCHAR', true, 255, null);
        $this->addColumn('is_symbol_before', 'IsSymbolBefore', 'BOOLEAN', true, 1, false);
    ...
    {
        $this->addRelation('CurrentCurrencyUser', '\\Models\\User', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':currency_id',
    1 => ':id',
  ),
), 'SET NULL', null, 'CurrentCurrencyUsers', false);
        $this->addRelation('CurrentCurrencyCourseStream', '\\Models\\CourseStream', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':currency_id',
    1 => ':id',
  ),
), 'CASCADE', null, 'CurrentCurrencyCourseStreams', false);
        $this->addRelation('CurrentDefaultCurrencyRate', '\\Models\\CurrencyRate', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':default_currency_id',
    1 => ':id',
  ),
), 'CASCADE', null, 'CurrentDefaultCurrencyRates', false);
        $this->addRelation('CurrentToCurrencyRate', '\\Models\\CurrencyRate', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':to_currency_id',
    1 => ':id',
  ),
), 'CASCADE', null, 'CurrentToCurrencyRates', false);
        $this->addRelation('CurrentCurrencyFeedback', '\\Models\\Feedback', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':currency_id',
    1 => ':id',
  ),
), 'SET NULL', null, 'CurrentCurrencyFeedbacks', false);
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CurrencyTableMap::COL_ISO_CODE);
            $criteria->addSelectColumn(CurrencyTableMap::COL_SYMBOL);
            $criteria->addSelectColumn(CurrencyTableMap::COL_IS_SYMBOL_BEFORE);
            $criteria->addSelectColumn(CurrencyTableMap::COL_NOTES);
            $criteria->addSelectColumn(CurrencyTableMap::COL_SORTABLE_RANK);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.name');
            $criteria->addSelectColumn($alias . '.iso_code');
            $criteria->addSelectColumn($alias . '.symbol');
            $criteria->addSelectColumn($alias . '.is_symbol_before');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Models\Currency) { // it's a model object
