...
class ConfigTableMap extends TableMap
{
     ...
     */
    const COL_DATA = 'config.data';

    /**
     * the column name for the seo field
     */
    const COL_SEO = 'config.seo';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Key', 'Value', 'Data', 'Seo', ),
        self::TYPE_CAMELNAME     => array('id', 'key', 'value', 'data', 'seo', ),
        self::TYPE_COLNAME       => array(ConfigTableMap::COL_ID, ConfigTableMap::COL_KEY, ConfigTableMap::COL_VALUE, ConfigTableMap::COL_DATA, ConfigTableMap::COL_SEO, ),
        self::TYPE_FIELDNAME     => array('id', 'key', 'value', 'data', 'seo', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Key' => 1, 'Value' => 2, 'Data' => 3, 'Seo' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'key' => 1, 'value' => 2, 'data' => 3, 'seo' => 4, ),
        self::TYPE_COLNAME       => array(ConfigTableMap::COL_ID => 0, ConfigTableMap::COL_KEY => 1, ConfigTableMap::COL_VALUE => 2, ConfigTableMap::COL_DATA => 3, ConfigTableMap::COL_SEO => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'key' => 1, 'value' => 2, 'data' => 3, 'seo' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('key', 'Key', 'VARCHAR', false, 60, null);
        ...
        $this->addColumn('seo', 'Seo', 'OBJECT', false, null, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ConfigTableMap::COL_DATA);
            $criteria->addSelectColumn(ConfigTableMap::COL_SEO);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.key');
            $criteria->addSelectColumn($alias . '.value');
            $criteria->addSelectColumn($alias . '.data');
            $criteria->addSelectColumn($alias . '.seo');
        }
    }
