...
/**
 * Base class that represents a row from the 'passport' table.
 *
 *
 *
 * @package    propel.generator.Models.Base
 */
abstract class Passport implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Models\\Map\\PassportTableMap';
    ...
    /**
     * Initializes internal state of Models\Base\Passport object.
     */
    ...
    /**
     * Compares this with another <code>Passport</code> instance.  If
     * <code>obj</code> is an instance of <code>Passport</code>, delegates to
     * <code>equals(Passport)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Passport The current object, for fluid interface
     */
    ...
    public function setserial($v)
    {
        ...
        if ($this->serial !== $v) {
            $this->serial = $v;
            $this->modifiedColumns[PassportTableMap::COL_SERIAL] = true;
        }
    ...
    public function setinn($v)
    {
        ...
        if ($this->inn !== $v) {
            $this->inn = $v;
            $this->modifiedColumns[PassportTableMap::COL_INN] = true;
        }
    ...
    public function setstartDate($v)
    {
        ...
        if ($this->start_date !== null || $dt !== null) {
            if ($this->start_date === null || $dt === null || $dt->format("Y-m-d") !== $this->start_date->format("Y-m-d")) {
                ...
                $this->modifiedColumns[PassportTableMap::COL_START_DATE] = true;
            }
    ...
    public function setoperator($v)
    {
        ...
        if ($this->operator !== $v) {
            $this->operator = $v;
            $this->modifiedColumns[PassportTableMap::COL_OPERATOR] = true;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[PassportTableMap::COL_USER_ID] = true;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPassportQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Passport::setDeleted()
     * @see Passport::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPassportQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PassportTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PassportTableMap::COL_INN)) {
            $modifiedColumns[':p' . $index++]  = '`inn`';
        }
        if ($this->isColumnModified(PassportTableMap::COL_START_DATE)) {
            $modifiedColumns[':p' . $index++]  = '`start_date`';
        }
        if ($this->isColumnModified(PassportTableMap::COL_OPERATOR)) {
            $modifiedColumns[':p' . $index++]  = '`operator`';
        }
        if ($this->isColumnModified(PassportTableMap::COL_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`user_id`';
        }

        $sql = sprintf(
            'INSERT INTO `passport` (%s) VALUES (%s)',
    ...
    {
        $pos = PassportTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Passport'][$this->hashCode()])) {
            return '*RECURSION*';
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Models\Passport The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PassportTableMap::COL_INN)) {
            $criteria->add(PassportTableMap::COL_INN, $this->inn);
        }
        if ($this->isColumnModified(PassportTableMap::COL_START_DATE)) {
            $criteria->add(PassportTableMap::COL_START_DATE, $this->start_date);
        }
        if ($this->isColumnModified(PassportTableMap::COL_OPERATOR)) {
            $criteria->add(PassportTableMap::COL_OPERATOR, $this->operator);
        }
        if ($this->isColumnModified(PassportTableMap::COL_USER_ID)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Models\Passport (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Models\Passport Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(PassportTableMap::DEFAULT_STRING_FORMAT);
    }
