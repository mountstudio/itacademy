...
abstract class Project implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Models\\Map\\ProjectTableMap';
    ...
    /**
     * Initializes internal state of Models\Base\Project object.
     */
     ...
     * @return $this|\Models\Project The current object (for fluent API support)
     */
    ...
    public function setAltUrl($v)
    {
        ...
        if ($this->alt_url !== $v) {
            $this->alt_url = $v;
            $this->modifiedColumns[ProjectTableMap::COL_ALT_URL] = true;
        }
    ...
    public function setLogoName($v)
    {
        ...
        if ($this->logo_name !== $v) {
            $this->logo_name = $v;
            $this->modifiedColumns[ProjectTableMap::COL_LOGO_NAME] = true;
        }
    ...
    public function setCoverName($v)
    {
        ...
        if ($this->cover_name !== $v) {
            $this->cover_name = $v;
            $this->modifiedColumns[ProjectTableMap::COL_COVER_NAME] = true;
        }
    ...
    public function setContext($v)
    {
        ...
        if ($this->context !== $v) {
            $this->context = $v;
            $this->modifiedColumns[ProjectTableMap::COL_CONTEXT] = true;
        }
    ...
    public function setMetaDescription($v)
    {
        ...
        if ($this->meta_description !== $v) {
            ...
            $this->modifiedColumns[ProjectTableMap::COL_META_DESCRIPTION] = true;
        }
    ...
    public function setMetaKeywords($v)
    {
        ...
        if ($this->meta_keywords !== $v) {
            ...
            $this->modifiedColumns[ProjectTableMap::COL_META_KEYWORDS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ProjectTableMap::translateFieldName('AltUrl', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ProjectTableMap::translateFieldName('LogoName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->logo_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ProjectTableMap::translateFieldName('CoverName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cover_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ProjectTableMap::translateFieldName('Context', TableMap::TYPE_PHPNAME, $indexType)];
            $this->context = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : ProjectTableMap::translateFieldName('MetaDescription', TableMap::TYPE_PHPNAME, $indexType)];
            $this->meta_description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : ProjectTableMap::translateFieldName('MetaKeywords', TableMap::TYPE_PHPNAME, $indexType)];
            $this->meta_keywords = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : ProjectTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : ProjectTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 11; // 11 = ProjectTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Models\\Project'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ProjectTableMap::COL_ALT_URL)) {
            $modifiedColumns[':p' . $index++]  = 'alt_url';
        }
        if ($this->isColumnModified(ProjectTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(ProjectTableMap::COL_LOGO_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'logo_name';
        }
        if ($this->isColumnModified(ProjectTableMap::COL_COVER_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'cover_name';
        }
        if ($this->isColumnModified(ProjectTableMap::COL_CONTEXT)) {
            $modifiedColumns[':p' . $index++]  = 'context';
        }
        if ($this->isColumnModified(ProjectTableMap::COL_META_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'meta_description';
        }
        if ($this->isColumnModified(ProjectTableMap::COL_META_KEYWORDS)) {
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Models\Project The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectTableMap::COL_ALT_URL)) {
            $criteria->add(ProjectTableMap::COL_ALT_URL, $this->alt_url);
        }
        if ($this->isColumnModified(ProjectTableMap::COL_DESCRIPTION)) {
            $criteria->add(ProjectTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(ProjectTableMap::COL_LOGO_NAME)) {
            $criteria->add(ProjectTableMap::COL_LOGO_NAME, $this->logo_name);
        }
        if ($this->isColumnModified(ProjectTableMap::COL_COVER_NAME)) {
            $criteria->add(ProjectTableMap::COL_COVER_NAME, $this->cover_name);
        }
        if ($this->isColumnModified(ProjectTableMap::COL_CONTEXT)) {
            $criteria->add(ProjectTableMap::COL_CONTEXT, $this->context);
        }
        if ($this->isColumnModified(ProjectTableMap::COL_META_DESCRIPTION)) {
            $criteria->add(ProjectTableMap::COL_META_DESCRIPTION, $this->meta_description);
        }
        if ($this->isColumnModified(ProjectTableMap::COL_META_KEYWORDS)) {
            $criteria->add(ProjectTableMap::COL_META_KEYWORDS, $this->meta_keywords);
        }
        if ($this->isColumnModified(ProjectTableMap::COL_CREATED_AT)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Models\Project (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Models\Project Clone of current object.
     * @throws PropelException
     */
